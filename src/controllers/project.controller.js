  ...
  try {
    ...
    if (err.message === "FORBIDDEN")
      return errorResponse(
        res,
        403,
        "Bạn không có quyền sửa dự án này",
        "FORBIDDEN"
      );
...
export const getProjectByUserLogin = async (req, res) => {
  try {
...
export const getAll = async (req, res) => {
  try {
    ...
    return successResponse(res, "Lấy danh sách dự án thành công", data);
  } catch (err) {
    return errorResponse(res, 500, "Lỗi hệ thống", err.message);
  }
};
